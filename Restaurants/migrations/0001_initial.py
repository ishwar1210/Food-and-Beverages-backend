    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cuisines', models.ManyToManyField(blank=True, related_name='categories', to='Restaurants.cuisine')),
        ...
        migrations.AddField(
            model_name='cuisine',
            name='master_cuisine',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='restaurant_cuisines', to='Restaurants.mastercuisine'),
        ),
        migrations.CreateModel(
            name='MasterItem',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master_price', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Restaurants.customer')),
                ('items', models.ManyToManyField(related_name='Restaurant_kot_items', to='Restaurants.order')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Restaurant_kot_order', to='Restaurants.order')),
                ('restaurant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Restaurants.restaurant')),
            ],
            options={
                'abstract': False,
        ...
        migrations.AddField(
            model_name='cuisine',
            name='restaurant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cuisines', to='Restaurants.restaurant'),
        ),
        migrations.CreateModel(
            name='Billing',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('deleted_by_id', models.BigIntegerField(blank=True, null=True)),
                ('status', models.CharField(choices=[('available', 'Available'), ('booked', 'Booked'), ('occupied', 'Occupied')], max_length=50)),
                ('restaurant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Restaurants.restaurant')),
                ('floor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Restaurants.tablebookingfloor')),
            ],
            options={
                'abstract': False,
            },
